(function () {
  const DATA_URL = 'data/rk-drive-reports.json';
  const MONTHS = [
  ...
  function detectPeriod(title) {
    // "Rekluta_Julio2026" o "1-13Sep2026": se separan letras y numeros para reconocer mes y ano.
  ...
  async function loadData() {
    if (window.RK_DRIVE_REPORTS) return window.RK_DRIVE_REPORTS;
